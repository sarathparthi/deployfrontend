...
const BarcodeScanner = () => {
  ...
  return (
    <div className="barcode-scanner">
      <h1 className="scanner-heading">Barcode Scanner</h1>
      {!cameraActive ? (
      ...
      {cameraActive && (
        <div className="webcam-container">
          <p>Scan a barcode and the data will be displayed below:</p>
          <Webcam
            audio={false}
            ref={webcamRef}
      ...
      <h2 className="barcode-data-heading">Scanned Barcode Data:</h2>
